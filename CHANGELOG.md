...
### Fixed
- Correctly remove duplicates from the feed
...
[Unreleased]: https://github.com/Necoro/feed2imap-go/compare/v1.8.0...HEAD
[1.8.0]: https://github.com/Necoro/feed2imap-go/compare/v1.7.2...v1.8.0
